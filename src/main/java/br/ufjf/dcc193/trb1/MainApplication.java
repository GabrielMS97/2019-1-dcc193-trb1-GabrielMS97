...
public class MainApplication {
	...
	public static void main(String[] args) {
		...
		Sede s1 = new Sede("Sede JF", "Minas Gerais", "Juiz de Fora", "Poço Rico", "(32)1234-4321", "www.seila.com.br");
		Sede s2 = new Sede("Sede RJ", "Rio de Janeiro", "Rio de Janeiro", "Irajá", "(21)1234-4321", "www.seila.com.br");
		repSede.save(s1);
		repSede.save(s2);
		...
		Membro m2 = new Membro("Zeca", "Diretor", "zeca@zeca", "09-06-2015", "09-02-2019", s2);
		repMembros.save(m1);
		repMembros.save(m2);
